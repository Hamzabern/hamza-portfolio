...
/>
      ...
      <div className="mt-8 grid sm:grid-cols-3 gap-3 text-sm">
        {[
          ...
          <div key={t} className="rounded-lg border border-black/10 dark:border-white/10 px-3 py-2 bg-white/50 dark:bg-white/5">
              {t}
          </div>
        ))}
      </div>
    ...
    <Section id="tech" title="Technologies" subtitle="Mon stack principal.">
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 text-sm">
        {[
          ...
          <div key={x} className="rounded-lg border border-black/10 dark:border-white/10 px-3 py-3 text-center bg-white/60 dark:bg-white/5 hover:shadow-accent transition" >
            {x}
          </div>
        ))}
      </div>
  ...
  <div className="relative pl-5">
    ...
    {/* CLIENTS / STACK */}
<Section id="clients" title="Stack & Clients" subtitle="Technos et marques avec qui j’ai travaillé.">
  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 items-center">
    {[
      ...
      { name: "Tailwind", img: "https://tailwindcss.com/favicons/apple-touch-icon.png" },
      { name: "MySQL", img: "https://www.mysql.com/common/logos/logo-mysql-170x115.png" },
      { name: "GitHub", img: "https://github.githubassets.com/favicons/favicon.png" },
      { name: "LinkedIn", img: "https://cdn-icons-png.flaticon.com/512/174/174857.png" },
    ].map((c) => (
      <div
        key={c.name}
        className="flex items-center justify-center p-4 rounded-lg bg-white/60 dark:bg-white/5 border border-black/10 dark:border-white/10 shadow-accent hover:shadow-accent transition"
      >
        <img
          src={c.img}
          alt={c.name}
