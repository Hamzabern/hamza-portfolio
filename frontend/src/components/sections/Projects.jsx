  ...
  return (
    <Section id="projects" title="Projets récents" subtitle={`${filtered.length} projet(s) — filtre par stack, recherche, tri.`} >
      ...
      <div className="proj-toolbar">
        <input className="searchbox" type="search" placeholder="Rechercher un projet…" value={query} onChange={(e) => setQuery(e.target.value)}
        ...
        <select className="sorter" value={sortBy} onChange={(e) => setSortBy(e.target.value)} aria-label="Trier les projets" >
      ...
      {visibleProjects.length === 0 ? (
        <p className="muted">Aucun résultat. Essaie d’enlever des filtres ou change la recherche.</p>
      ) : (
